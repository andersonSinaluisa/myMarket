...
public class FullscreenPhoto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String EDteamImage = getImg(FullscreenPhoto.this);
        Glide.with(FullscreenPhoto.this).load(EDteamImage).into(mContentView);


        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(FullscreenPhoto.this, Principal.class);
                startActivity(i);
            }
        });
