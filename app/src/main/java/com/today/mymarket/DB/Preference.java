...
public class Preference {
    ...
    public static void datostienda(Context c, String nombre, String identificacion, String id_tienda,String t_ident, int estado, String direccion, String telefono){
        SharedPreferences sharedPref= c.getSharedPreferences(c.getString(R.string.app_name), c.MODE_PRIVATE);
        SharedPreferences.Editor editor =sharedPref.edit();
    ...
    public static String telefono(Context c){
        SharedPreferences sharedPref= c.getSharedPreferences(c.getString(R.string.app_name), c.MODE_PRIVATE);
        return sharedPref.getString("telefono","");
    }
    public static String direccion(Context c){
        SharedPreferences sharedPref= c.getSharedPreferences(c.getString(R.string.app_name), c.MODE_PRIVATE);
        return sharedPref.getString("direccion","");
    }
