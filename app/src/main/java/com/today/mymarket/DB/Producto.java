...
public class Producto {
    ...
    public Producto(String id_producto, int codigo, String nombre, String detalle, String url_img, double precio,
                    double pvp, String id_tienda, String id_proveedor, String id_tipo_producto) {
