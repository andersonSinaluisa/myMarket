...
public class RegistroTienda extends AppCompatActivity {
    ...
    private Button btn;
    private EditText et_nombre_tienda, et_identificacion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Cedula", "RUC"};
                ...
                if (dataSnapshot.exists()) {
                    for (DataSnapshot objSnaptshot : dataSnapshot.getChildren()) {
                        ...
                        if (u.getIdentificacion().equals(identificacion)) {
                            ...
                            datostienda(RegistroTienda.this,p.getNombre(),p.getIdentificacion(),p.getId_tienda(),p.getTipo_id(),p.getEstado());
